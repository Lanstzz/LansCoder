...
from lanscoder.app.activity_view import single_line_activity, truncate_activity_text


def test_single_line_activity_folds_newlines_but_keeps_animation_spaces() -> None:
    assert single_line_activity("thinking ⠋ 好的，我来分析。\n先看下目录结构") == "thinking ⠋ 好的，我来分析。 先看下目录结构"
