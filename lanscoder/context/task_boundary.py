...
from lanscoder.context.identity import new_event_id, stable_json_hash
from lanscoder.context.runtime_state import SessionRuntimeState
from lanscoder.context.models import utc_now_iso
from lanscoder.context.versions import CONTEXT_EVENT_SCHEMA_VERSION, TASK_BOUNDARY_TOOL_VERSION
...
def observation_from_tool_result_data(data: dict[str, object]) -> TaskBoundaryObservation | None:
    ...
    if not decision or not basis_message_id or event_version != CONTEXT_EVENT_SCHEMA_VERSION or strategy_version != TASK_BOUNDARY_TOOL_VERSION:
        return None
