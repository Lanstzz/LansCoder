...
FirstCoder 目前最有辨识度的创新点，是这套 **任务边界触发的上下文压缩层**。
...
简单说，FirstCoder 想把压缩从“上下文快爆了才救火”，推进成“跟随任务生命周期主动整理上下文”。当前实现还在早期，但方向很明确：让长时间 coding session 更容易恢复、更容易检查，也更不容易被旧任务细节污染。
...
- 做多代理编排，支持 planner/executor/reviewer 这类工作流，以及并行 coding task。
